...
import {
    CREATE_RIDE,
    EDIT_RIDE, FORM_RIDE, FORM_USER,
    LOGIN_USER, REGISTER_ERRORS,
    REGISTER_USER,
    RIDE_REQUESTS,
    RIDES_LIST,
    SHOW_RIDE, STATUS_CODE
} from "../../actions/Types";
...
describe('test reducers', () => {
    ...
    it('should update state on successful  register', () => {
        ...
        expect(afterState.register_user.user).toEqual(
            sampleResponse.user
        );
    });
    ...
    it('should update state on register errors', () => {
        ...
        expect(afterState.register_user.errors).toEqual(
             {message:"sorry error"}
        );
    });
