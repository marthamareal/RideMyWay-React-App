            ...
            <div className="content">
                <div className="signup-login about-us">
                    ...
                    <br/>
                        ...
                        <p>When you are a driver, you can <a href="create-ride.html">create</a> a ride and friend can
                            join you.</p>
                        <p>When you are a rider, you can <a href="ride-offer-list.html">request to join </a> a ride from
                            a list of ride offers created by your friends.</p><br/>
