...
import {deleteRide, editRide, formRide, getRide, requestRide, showRide} from "../../actions/Rides";
...
class ShowRide extends React.Component {
    ...
    onDelete = async event => {
        ...
        if (this.props.errors.includes('deleted successfully')) {
            M.toast({
            ...
            M.toast({html: `Failed to delete ride ${this.props.errors}`, classes: "red darken-3"});
            this.props.history.goBack();
        }
    };
    ...
    onRequest = async event => {
        ...
        if (this.props.status === 201) {
            ...
            M.toast({html: `Failed to request ride, ${this.props.errors}`, classes: "red darken-3"});
            this.props.history.goBack();
        }
    };
                ...
                <h5>
                  {" "}
                    {this.props.ride.ref_no} by {this.props.ride.creator}
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {this.props.ride.requests > 0 && this.props.isOwner && (
                                            <button
                            ...
                            <RideAction isOwner={this.props.isOwner} onRequest={this.onRequest}
                                        onEdit={this.onEdit} ride={this.props.ride}
...
export const RideAction = (props) => {
    ...
    return (
        <div className="card-action">
            ...
            {props.ride.requests <= 0 && props.isOwner && (
                <a
